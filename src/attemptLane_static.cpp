...
int main(int argc, char *argv[])
{
    ...
    cv::Mat color_image = cv::imread("/home/nash/Desktop/Simulator/src/LaneDetection/src/lane_image.png");
    cv::Mat grayscale_image;
    cv::cvtColor(color_image, grayscale_image, cv::COLOR_BGR2GRAY);
    cv::Mat ipm_color = detector.getIPM(color_image);
    cv::Mat ipm_image = detector.getIPM(grayscale_image);
    ...
    cv::Mat gyu_img = detector.viz3(ipm_color,color_image, ret, waypoints,y_Values);
